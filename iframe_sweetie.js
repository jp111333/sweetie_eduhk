function embedChatbot() {
  ...
  ChatBtn.style.cssText =
    'position: fixed; bottom: 30px; right: 385px; width: 80px; height: 100px; cursor: pointer; z-index: 2147483647; transition: 0;';
  ...
  iframe.style.cssText =
    'border: none; position: fixed; flex-direction: column; justify-content: space-between; box-shadow: rgba(150, 150, 150, 0.2) 0px 10px 30px 0px, rgba(150, 150, 150, 0.2) 0px 0px 0px 1px; bottom: 30px; right: 30px; width: 350px; height: 400px; max-width: 90vw; max-height: 85vh; border-radius: 0.75rem; display: flex; z-index: 2147483647; overflow: hidden; left: unset; background-color: #F3F4F6;';
